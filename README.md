...
1. [**Prerequisite check** - Before getting started, we want to make sure that everyone is ready to start](https://github.com/git-merge-workshops/git-it-right/issues/1)
